...
export default function Sidebar(){
    ...
    return(
        <div className=" w-full overflow-y-auto  flex flex-col sidebar-container mt-3" >
            ...
            <div className="h-[40px] flex justify-center items-center p-[16px] ">
...

                {
                    ...
                    formsData.map((form)=>(
                        ...
                        > 
                            <p className=" text-[#737373] whitespace-nowrap w-full overflow-hidden">{form.title.length >= 24 ? `${form.title.substr(0,24)}...` : form.title}</p>
                            <p className="text-[#737373]">{form.responses.length}</p>
                        </div>
                    ))
                }
            ...
            <div className="relative h-[150px] w-[256px] p-[16px] border-t flex flex-col gap-4 border-b pb-0">
                    ...
                    <div className="flex flex-col gap-3  w-full">
                        ...
                        <div className="h-[4px] w-full bg-[#f0f0f0] rounded-full relative">
                            <span className={`h-[4px] w-full origin-left scale-x-[${(userDetails?.level)/10}] bg-[#0287af] absolute rounded-full`} > </span>                     
                        </div>
