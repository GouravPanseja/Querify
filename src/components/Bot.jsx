...
export default function Bot (){
    ...
    return(
        ...
        <div>
            ...
            <div  
                className={`fixed bottom-0 right-0 bg-[#056251] py-1 px-3 text-white z-[999] rounded-t-sm cursor-pointer flex gap-3 items-center transition-opacity duration-200 ${ showBot ? "opacity-0": "opacity-100"}`}
